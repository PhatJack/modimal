  ...
  ui: {
    ...
    navigationMenu: {
      slots: {
        ...
        item: 'min-w-0',
        link: 'group relative w-full flex items-center gap-1.5 font-medium text-base before:absolute before:z-[-1] focus:outline-none focus-visible:outline-none dark:focus-visible:outline-none focus-visible:before:ring-inset focus-visible:before:ring-2',
        ...
        viewportWrapper: 'fixed top-full left-0 flex w-full h-dvh',
        viewport:
          'relative overflow-hidden bg-default shadow-lg ring ring-default rounded-none h-(--reka-navigation-menu-viewport-height) w-full transition-[width,height,left] duration-200 origin-[top_center] data-[state=open]:animate-[scale-in_100ms_ease-out] data-[state=closed]:animate-[scale-out_100ms_ease-in] z-[1]',
        content: 'max-w-(--ui-container) mx-auto px-4 sm:px-6 lg:px-8',
        indicator:
      ...
      variants: {
        ...
        orientation: {
          horizontal: {
            ...
            content: 'absolute top-0 left-1/2 -translate-x-1/2 w-full max-h-[70vh] overflow-y-auto',
          },
          vertical: {
            root: 'flex-col',
        ...
        contentOrientation: {
          ...
          vertical: {
            viewport: 'sm:w-screen left-(--reka-navigation-menu-viewport-left)',
          },
        },
        active: {
          true: {
